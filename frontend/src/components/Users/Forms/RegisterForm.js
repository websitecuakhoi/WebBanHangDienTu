    ...
    <>
      <section className="relative overflow-x-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url("https://th.bing.com/th/id/OIP.nFzJV5f6f6OJ-EqX8o2YNgHaHa?pid=ImgDet&w=474&h=474&rs=1")',
            backgroundSize: 'cover', // Đảm bảo ảnh hiển thị đủ rõ nét
            backgroundPosition: 'center', // Căn giữa ảnh
            width: '600px', // Chiều rộng mới
            height: '600px', // Chiều cao mới
          }}
        />
